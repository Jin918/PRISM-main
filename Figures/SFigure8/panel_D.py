...
FIGURE_ID = 'SFigure8'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'Held-out and external discrimination across K'
ORIGIN_HINT = 'results/supplementary_figures/SFigure8_prototype_interpretation_robustness/Supplementary_Figure_S8_final.pdf'
NOTE = ''
BUILDER_KIND = 'python'
BUILDER_SCRIPT = REPO_ROOT / 'results/supplementary_figures/SFigure8_prototype_interpretation_robustness/make_sfigure8_style_refined.py'
BUILDER_ARGS = []
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure8_prototype_interpretation_robustness/SFigure8_pdf_exports/Supplementary_Figure_S8_panel_D.pdf',
]]
