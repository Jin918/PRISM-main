...
FIGURE_ID = 'SFigure8'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'Pathway allocation concentration across K'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure8_prototype_interpretation_robustness/SFigure8_pdf_exports/Supplementary_Figure_S8_panel_B.pdf',
]]
