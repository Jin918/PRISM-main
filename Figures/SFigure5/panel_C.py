...
FIGURE_ID = 'SFigure5'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'CPTAC external feature attribution'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure5_feature_attribution/SFigure5B_CPTAC_external_feature_attribution.pdf',
    'results/supplementary_figures/SFigure5_feature_attribution/SFigure5B_CPTAC_external_feature_attribution.png',
]]
