...
FIGURE_ID = 'SFigure5'
PANEL_ID = 'A'
PANEL_DESCRIPTION = 'Final integrated prognostic nomogram'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4A_nomogram.pdf',
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4A_nomogram.png',
]]
