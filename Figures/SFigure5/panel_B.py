...
FIGURE_ID = 'SFigure5'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'TCGA internal validation feature attribution'
ORIGIN_HINT = 'results/supplementary_figures/SFigure5_feature_attribution/make_supplementary_figure_5_feature_attribution.R'
NOTE = ''
BUILDER_KIND = 'rscript'
BUILDER_SCRIPT = REPO_ROOT / 'results/supplementary_figures/SFigure5_feature_attribution/make_supplementary_figure_5_feature_attribution.R'
BUILDER_ARGS = [
    '--figures',
    'S4,S5',
]
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure5_feature_attribution/SFigure5A_TCGA_internal_feature_attribution.pdf',
    'results/supplementary_figures/SFigure5_feature_attribution/SFigure5A_TCGA_internal_feature_attribution.png',
]]
