...
FIGURE_ID = 'SFigure6'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'CPTAC external directional pathway-score support'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure6_pathway_biology/Supplementary_Figure_6_pathway_biology_panel_C.pdf',
    'results/supplementary_figures/SFigure6_pathway_biology/Supplementary_Figure_6_pathway_biology_panel_C.png',
]]
