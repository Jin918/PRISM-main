...
FIGURE_ID = 'SFigure6'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'TCGA low-risk-associated pathway programs'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure6_pathway_biology/Supplementary_Figure_6_pathway_biology_panel_B.pdf',
    'results/supplementary_figures/SFigure6_pathway_biology/Supplementary_Figure_6_pathway_biology_panel_B.png',
]]
