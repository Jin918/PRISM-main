...
FIGURE_ID = 'SFigure4'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'TCGA validation 36-month calibration'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4B_TCGA_validation_calibration.pdf',
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4B_TCGA_validation_calibration.png',
]]
