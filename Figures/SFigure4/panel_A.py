...
FIGURE_ID = 'SFigure4'
PANEL_ID = 'A'
PANEL_DESCRIPTION = 'TCGA full-cohort calibration'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4_TCGA_all_cohort_calibration.pdf',
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4_TCGA_all_cohort_calibration.png',
]]
