...
FIGURE_ID = 'SFigure4'
PANEL_ID = 'E'
PANEL_DESCRIPTION = 'CPTAC external 36-month calibration'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4C_CPTAC_external_calibration.pdf',
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4C_CPTAC_external_calibration.png',
]]
