...
FIGURE_ID = 'SFigure4'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'TCGA validation DCA at 36 months'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4D_TCGA_validation_DCA.pdf',
    'results/supplementary_figures/SFigure4_clinical_implementation/SFigure4D_TCGA_validation_DCA.png',
]]
