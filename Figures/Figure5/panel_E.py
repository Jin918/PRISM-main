...
FIGURE_ID = 'Figure5'
PANEL_ID = 'E'
PANEL_DESCRIPTION = 'One pathway shown across TCGA/CPTAC low/high-risk case blocks'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure5/Figure5E_within_case_prototype_localization_largefont.pdf',
]]
