...
FIGURE_ID = 'Figure5'
PANEL_ID = 'F'
PANEL_DESCRIPTION = 'Prototype-centered morphology panel using filtered TCGA/CPTAC patch exemplars'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure5/Figure5F_representative_patch_burden_boxplot.pdf',
]]
