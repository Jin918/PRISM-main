...
FIGURE_ID = 'Figure5'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'External morphological validation of learned prototypes in CPTAC-UCEC'
ORIGIN_HINT = 'Figure-main/Figure5/revised_final/Figure5_source_manifest.tsv'
NOTE = ''
BUILDER_KIND = 'python'
BUILDER_SCRIPT = REPO_ROOT / 'Figure-main/script/make_figure5.py'
BUILDER_ARGS = []
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure5/Figure5D_CPTAC_prototype_morphology_manual_selected_publication_ready.pdf',
]]
