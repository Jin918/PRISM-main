...
FIGURE_ID = 'Figure5'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'Representative morphology of learned prototypes in TCGA-UCEC'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure5/Figure5C_TCGA_prototype_morphology_manual_selected.pdf',
]]
