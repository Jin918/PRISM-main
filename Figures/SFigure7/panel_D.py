...
FIGURE_ID = 'SFigure7'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'Transparent audit of excluded P4'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_D.pdf',
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_D.png',
]]
