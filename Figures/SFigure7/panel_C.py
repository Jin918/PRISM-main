...
FIGURE_ID = 'SFigure7'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'CPTAC within-case prototype spatial localization'
ORIGIN_HINT = 'results/supplementary_figures/SFigure7_full_prototype_interpretation/make_supplementary_figure_7_full_prototype_interpretation.py'
NOTE = ''
BUILDER_KIND = 'python'
BUILDER_SCRIPT = REPO_ROOT / 'results/supplementary_figures/SFigure7_full_prototype_interpretation/make_supplementary_figure_7_full_prototype_interpretation.py'
BUILDER_ARGS = []
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_C.pdf',
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_C.png',
]]
