...
FIGURE_ID = 'SFigure7'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'TCGA within-case prototype spatial localization'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_B.pdf',
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_B.png',
]]
