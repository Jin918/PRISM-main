...
FIGURE_ID = 'SFigure7'
PANEL_ID = 'A'
PANEL_DESCRIPTION = 'Prototype-wise top pathway ranking'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_A.pdf',
    'results/supplementary_figures/SFigure7_full_prototype_interpretation/Supplementary_Figure_7_full_prototype_interpretation_panel_A.png',
]]
