...
FIGURE_ID = 'Figure3'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'CPTAC clinical-integration ROC at 36 months'
ORIGIN_HINT = 'Figure-main/script/figure3_publication_core.R'
NOTE = ''
BUILDER_KIND = 'rscript'
BUILDER_SCRIPT = REPO_ROOT / 'Figure-main/script/make_figure3.R'
BUILDER_ARGS = []
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure3/Figure3B_CPTAC_clinical_integration_ROC_36m.pdf',
    'Figure-main/Figure3/Figure3B_CPTAC_clinical_integration_ROC_36m.png',
]]
