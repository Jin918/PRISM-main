...
FIGURE_ID = 'Figure3'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'Landmark AUC step-up summary'
ORIGIN_HINT = 'Figure-main/script/figure3C_auc_stepup_core.R'
NOTE = ''
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure3/Figure3C_AUC_stepup_36m.pdf',
    'Figure-main/Figure3/Figure3C_AUC_stepup_36m.png',
]]
