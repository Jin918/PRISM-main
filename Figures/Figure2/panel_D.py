...
FIGURE_ID = 'Figure2'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'CPTAC external-validation ROC at 36 months'
ORIGIN_HINT = 'Figure-main/script/figure2D_cptac_roc.R'
NOTE = ''
BUILDER_KIND = 'rscript'
BUILDER_SCRIPT = REPO_ROOT / 'Figure-main/script/make_figure2.R'
BUILDER_ARGS = []
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure2/Figure2D_tdROC_CPTAC_external_validation_36m.pdf',
    'Figure-main/Figure2/Figure2D_tdROC_CPTAC_external_validation_36m.png',
]]
