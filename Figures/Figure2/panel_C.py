...
FIGURE_ID = 'Figure2'
PANEL_ID = 'C'
PANEL_DESCRIPTION = 'TCGA internal-validation ROC at 36 months'
ORIGIN_HINT = 'Figure-main/script/figure2C_vali_roc.R'
NOTE = ''
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure2/Figure2C_tdROC_TCGA_internal_validation_36m.pdf',
    'Figure-main/Figure2/Figure2C_tdROC_TCGA_internal_validation_36m.png',
]]
