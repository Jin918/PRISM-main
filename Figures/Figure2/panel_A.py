...
FIGURE_ID = 'Figure2'
PANEL_ID = 'A'
PANEL_DESCRIPTION = 'C-index comparison across cohorts'
ORIGIN_HINT = 'Figure-main/script/figure2A_cindex_barplot.R'
NOTE = ''
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure2/Figure2A_cindex_comparison.pdf',
    'Figure-main/Figure2/Figure2A_cindex_comparison.png',
]]
