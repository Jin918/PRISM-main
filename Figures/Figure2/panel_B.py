...
FIGURE_ID = 'Figure2'
PANEL_ID = 'B'
PANEL_DESCRIPTION = 'TCGA training ROC at 36 months'
ORIGIN_HINT = 'Figure-main/script/figure2B_train_roc.R'
NOTE = ''
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure2/Figure2B_tdROC_TCGA_training_36m.pdf',
    'Figure-main/Figure2/Figure2B_tdROC_TCGA_training_36m.png',
]]
