...
FIGURE_ID = 'Figure4'
PANEL_ID = 'D'
PANEL_DESCRIPTION = 'CPTAC spline and forest summary'
...
EXPECTED_OUTPUTS = [REPO_ROOT / relative_path for relative_path in [
    'Figure-main/Figure4/Figure4D_CPTAC_spline_forest.pdf',
    'Figure-main/Figure4/Figure4D_CPTAC_spline_forest.png',
]]
